                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg p-3">
                    ...
                    <div class=" px-4">
                        <div class="grid grid-cols-2 gap-4 items-start mb-3">
                            ...
                            <button @click="openCreateModal" class="justify-self-end w-48 h-12 flex items-center justify-center text-md font-medium text-violet-400 hover:text-violet-700 ">
                                + Додати Тікет
                            </button>
                        </div>
