            ...
            <div class="px-4">
                ...
                <form @submit.prevent="submit">
                    <div class="mb-4">
                        ...
                        <input v-model="form.subject" type="text" class="w-full border-gray-300 p-2 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea v-model="form.content" type="text"  class="w-full border-gray-300 p-2 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" />
                    </div>
