                ...
                <div class="bg-white shadow-sm sm:rounded-lg p-5">
                    ...
                    <div class="grid grid-cols-3 gap-3 mb-4">
                        <div v-for="photo in photos" :key="photo.id" class="relative group">
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center space-x-2 transition">
                                <button @click="setMainPhoto(photo)" class="bg-green-500 text-white px-2 py-1 rounded-md z-50">
                                    Головне
                                </button>
                                <button @click="removePhoto(photo.id)" class="bg-red-500 text-white px-2 py-1 rounded-md">
                                    Видалити
                                </button>
                            </div>
                        </div>
