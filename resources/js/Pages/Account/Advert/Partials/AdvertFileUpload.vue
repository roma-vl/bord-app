...
<template>
    <div class="border-2 border-dashed p-4 rounded-md" :class="{ 'border-blue-500': isDraggedOver }"
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 ">
            <div v-for="(file, key) in files" :key="key" class="relative border rounded overflow-hidden">
                ...
                <div class="absolute top-1 right-1">
                    <button type="button" class="bg-red-600 text-white rounded-full px-2 py-1 text-xs" @click="removeFile(key)">✕</button>
                </div>
