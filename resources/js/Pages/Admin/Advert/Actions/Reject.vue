...
const submit = () => {
    form.post(route("admin.adverts.actions.moderation.reject", {advert: props.advertId}), {
        onSuccess: () => {
            emit("rejectCreated");
            form.reset();
        },
                    ...
                    <div class="px-4">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                ...
                                <input v-model="form.reject_reason" type="text"  class="w-full border-gray-300 p-2 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" />
                            </div>
