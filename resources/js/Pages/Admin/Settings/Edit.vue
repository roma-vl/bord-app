                ...
                <div class="flex bg-white shadow sm:rounded-lg overflow-hidden">
                    ...
                    <aside class="w-1/4 bg-gray-50 border-r p-6">
                        ...
                        <ul class="space-y-1">
                            ...
                            >
                                ...
                                >
                                    <span v-html="getIcon(key)" class="w-5 h-5 shrink-0"></span>
                    ...
                    <div class="w-3/4 p-6">
                        ...
                        <form v-else @submit.prevent="submit" class="space-y-6">
                            <template v-if="props.group === 'general'">
                                ...
                                <div>
                                    <label class="inline-flex items-center gap-2">
                                        <input type="checkbox" v-model="form.maintenance_mode" class=" p-2.5 rounded shadow" />
                                        Maintenance Mode
                            ...
                            <template v-else-if="props.group === 'user'">
                                ...
                                <div>
                                    <label class="inline-flex items-center gap-2 relative group">
                                        <input type="checkbox" v-model="form.allow_registration" class="p-2.5 rounded shadow" />
                                        Allow Registration
                                ...
                                <div>
                                    <label class="inline-flex items-center gap-2">
                                        <input type="checkbox" v-model="form.require_email_verification" class=" p-2.5 rounded shadow"  />
                            ...
                            <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded shadow">
                                Зберегти
                            </button>
                        </form>
                    </div>
