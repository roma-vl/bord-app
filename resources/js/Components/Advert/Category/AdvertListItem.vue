...
<template>
    <div class=" flex bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow duration-200">
        <img class="object-cover w-48 h-48" :src="getFullPathForImage(advert.first_photo?.file)" :alt="advert.title"/>
        <div class="p-4 flex-1" >
            ...
            <button @click="toggleLike(advert)" class="px-4 py-2 rounded text-gray-500 hover:text-red-500 transition">
