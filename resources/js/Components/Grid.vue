...
const visibleColumns = useLocalStorageFn("visibleColumns", props.headings.map(h => h.key));
...
<template>
    <div class="grid-container shadow p-2 bg-white rounded-lg">
        ...
        <div v-else class="w-full border-collapse bg-white text-center text text-gray-800 border-b mb-2">
            No data found.
        </div>
