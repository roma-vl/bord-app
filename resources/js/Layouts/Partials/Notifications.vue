...
<template>
    <Dropdown align="right" width="72">
        ...
        <template #content>
            <ul class=" dark:bg-gray-700 dark:text-white flex-col gap-2 overflow-auto  bg-white p-3  font-sans text-sm
             font-normal text-blue-gray-500 shadow-blue-gray-500/10 focus:outline-none">
                <div role="menuitem" class=" flex w-full cursor-pointer select-none items-center gap-4 rounded-md px-3
                 py-2 pr-8 pl-2 text-start leading-tight outline-none transition-all hover:bg-gray-500/10
                  hover:border-gray-300  active:bg-gray-300 active:border-gray-800  dark:text-white">
                    <img alt="tania andrew"
                         src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1480&amp;q=80"
                         class="relative inline-block h-12 w-12 !rounded-full object-cover object-center"/>
                    <div class="flex flex-col gap-1">
                        <p class="block font-sans text-sm font-normal leading-normal text-gray-700 antialiased  dark:text-white">
                            <span class="font-medium text-blue-gray-900">Tania</span> send you a message
                        </p>
                        <p class="flex items-center gap-1 font-sans text-xs font-light text-gray-600 antialiased  dark:text-gray-300">
                            <svg
